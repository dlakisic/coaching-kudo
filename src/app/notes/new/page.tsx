...
export default async function NewNotePage({ searchParams }: { searchParams: Promise<{ athleteId?: string }> }) {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">
            Nouvelle note d'entraînement
          </h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            {preselectedAthlete 
              ? `Ajouter une note pour ${preselectedAthlete.name}`
              : 'Créer une nouvelle observation d\'entraînement ou de compétition'
            }
          </p>
        </div>
